...
class NavbarRecruiter extends Component
{
    public $menu = [];
    ...
    {
        //
        $this->menu = Menu::whereSlug('navbar-recruiter')->with(['items' => function($q){
    ...
    {
        return view('components.frontend.navbar-recruiter');
    }
}
