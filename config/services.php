...
return [
    ...
    */
    ...
    'tinymce' => [
        'key' => env('TINYMCE_KEY', 'no-api-key'),
    ],
    ...
    'tinkoff' => [
        'token' => env('TKF_TOKEN', ''),
        'sandbox' => env('TKF_SANDBOX', true),
        'terminal' => env('TKF_TERMINAL_ID', ''),
        'password' => env('TKF_TERMINAL_PASSWORD', ''),
    ],
    'telegram-bot-api' => [
        'token' => env('TELEGRAM_BOT_TOKEN', ''),
        'enable' => env('TELEGRAM_BOT_ENABLE', false),
    ],
];
